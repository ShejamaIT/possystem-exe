...
const TableAll = ({ refreshKey }) => {
    ...
    const fetchOrders = async () => {
        ...
        try {
            const endpoint =
                type === "ADMIN"
                    ? "http://localhost:5001/api/admin/main/ordersAll"
                    : `http://localhost:5001/api/admin/main/orders-all-stid?eid=${Eid}`;
