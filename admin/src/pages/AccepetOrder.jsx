...
const OrderDetails = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            // Step 1: Update order general details
        ...
        <Helmet title={`Order Details - ${order.orderId}`}>
            <section>
                ...
                <Container>
                    <Row>
                        <Col lg="12">
                            <h4 className="mb-3 text-center topic">Accepted Order Details</h4>
                                        ...
                                        <>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    if (userType === "ADMIN") {
                                                        navigate("/admin-dashboard/product_list?tab=Accepted");
                                                    } else {
                                                        navigate("/user-dashboard/product-list?tab=Accepted");
                                                    }
                                                }}
                                            >
