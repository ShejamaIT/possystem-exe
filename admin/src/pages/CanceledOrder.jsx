...
const CancelOrderDetails = () => {
    ...
    const fetchOrder = async () => {
        try {
            const response = await fetch(`http://localhost:5001/api/admin/main/cancel-order-details?orID=${id}`);
        ...
        <Helmet title={`Order Details - ${order.orderId}`}>
            <section>
                ...
                <Container>
                    <Row>
                        <Col lg="12">
                            <h4 className="mb-3 text-center topic">Canceled Order Details</h4>
                            ...
                            <div className="order-details">
                                <div className="order-header">
                                    ...
                                    <div className="order-general">
                                        ...
                                        <p><strong>Reason to Cancel:</strong> {order.returnReason}</p>
                                    </div>
                                </div>
                                {/* Ordered Items */}
                                    <div>
