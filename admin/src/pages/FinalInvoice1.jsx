...
const FinalInvoice1 = ({ selectedOrder, setShowModal2, handlePaymentUpdate,handleDeliveryNote,handleGatePass }) => {
    ...
    const netTotal = (Number(subtotal) || 0) + (Number(delivery) || 0) - (Number(selectedOrder?.discount) || 0 + specialDiscount) ;
    const debounceTimer = useRef(null);
    let balance =totalAdvance - netTotal;
            ...
            <div className="modal-content final-invoice">
                ...
                <div className="invoice-footer">
                    <div className="total-section">
                        ...
                        <p><strong>Payment:</strong> Rs. {advance.toFixed(2)}</p>
                    ...
                    <div className="modal-buttons">
                        ...
                        {selectedOrder?.deliveryStatus === "Pickup" && (
                            <button className="pass-btn" onClick={viewhandle1}>Get Gate Pass</button>
                        )}

                        {selectedOrder?.deliveryStatus === "Delivery" && (
                            <button className="pass-btn" onClick={viewhandle}>Get delivery Note</button>
                        )}
