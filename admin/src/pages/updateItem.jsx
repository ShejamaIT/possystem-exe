...
const UpdateItem = () => {
  ...
  const subCategoryOptions = {
    Home: ["Living Room", "Bedroom", "Dining Room", "Kitchen", "Varanda"],
    Office: ["Office Chair", "Office Table"],
    Kids: ["Kids Table", "Toys", "Baby Cot"],
    Hotel: ["Reception Chair", "Reception Table", "Bar Stool", "Sun Beds", "Deco"],
  };

  // Fetch all items & categories on load
  useEffect(() => {
    fetchItems();
    fetchCategories();
  }, []);
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleChange}
                disabled={!formData.mnCategory}
              >
                <option value="">Select Sub Category</option>
                {formData.mnCategory &&
                  subCategoryOptions[formData.mnCategory]?.map((sub, index) => (
            ...
            <FormGroup>
              ...
              >
                ...
                <option value="piyestra">Piyestra</option>
