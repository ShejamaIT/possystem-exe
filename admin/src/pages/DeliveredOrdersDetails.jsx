...
import "../style/orderDetailsUpdated.css"; // USE THIS CSS
import RegenarateReceiptView from "./ReceiptView";
                ...
                <Container>
                    <Row>
                        <Col lg="12" className="text-center">
                            <h2 className="order-title">Deivered Order Details</h2>
                                    ...
                                    <div className="text-center mt-3">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                if (userType === "ADMIN") {
                                                    navigate("/admin-dashboard/product_list?tab=Delivered");
                                                } else {
                                                    navigate("/user-dashboard/product-list?tab=Delivered");
                                                }
                                            }}
                                        >
