...
const CompleteOrderDetails = () => {
    ...
    const handleChange = (e, index) => {
        ...
        // 👇 Intercept orderStatus == "Cancelled" to show modal
        if (name === "orderStatus" && value === "Cancelled") {
            setPendingStatusValue(value);     // Temporarily store the status
            setReasonModal(true);             // Open modal
            return;                           // Skip normal update until confirmed
        }
                                        ...
                                        <>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    if (userType === "ADMIN") {
                                                        navigate("/admin-dashboard/product_list?tab=Completed");
                                                    } else {
                                                        navigate("/user-dashboard/product-list?tab=Completed");
                                                    }
                                                }}
                                            >
