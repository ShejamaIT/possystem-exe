...
const CashWeekly = () => {
    ...
    const fetchCashWeek = async () => {
        try {
            const res = await fetch("http://localhost:5001/api/admin/main/cash/week");
    ...
    return (
        <div className="p-3">
            <h5>This Week's Cash Transactions</h5>
            <Table bordered responsive hover>
                ...
                <tbody>
                    {cashRecords.length > 0 ? (
                        ...
                        <tr>
                            <td colSpan="6" className="text-center">No transactions this week.</td>
                        </tr>
                    )}
                </tbody>
            </Table>
